...
- 🛡️ Thread-safe event publication and subscription
...
- Efficient handler lookup using optimized data structures
- Configurable thread pool for handling concurrent events
